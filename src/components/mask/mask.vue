			...
			<div class="layer_sbox">
				<div class="layer" @click="layerPrevent">
					...
					<header class="layer_head" v-if="layerData.isHeader">
						<h3 class="layer_tit">{{ layerData.title }}</h3>
					</header>
					<!-- 标题 end -->
					...
					<div class="layer_btnbox" v-if="layerData.isBtn">
						<a href="javascript:;" class="layer_yes" :class="{ on: !layerData.isCancel }" @click="layerConfirm">{{ layerData.confirmText }}</a>
						<a href="javascript:;" class="layer_no" v-if="layerData.isCancel" @click="layerCancel">{{ layerData.cancelText }}</a>
					</div>
					<!-- 按钮区 end -->
